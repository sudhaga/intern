    ...
    <>
      <section className="px-5 md:py-10">
        <div className="flex justify-center px-5 py-20">
          <div className="grid grid-flow-col text-center md:text-xl">
            <div>
              ...
              <p className="px-4 md:px-6 py-6 text-sm md:text-3xl">
                ...
                <span className="text-green-500">src/App.jsx</span>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {Array(4)
              ...
              .map((_, i) => (
                <div
                  key={i}
                  className="border rounded-md p-5 transition hover:border-green-600"
                >
